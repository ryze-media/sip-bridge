...
export SIPGATE_INSTANCE_ID="11111111-2222-4333-8444-555555555555"
...
grep -Fq 'contact_header_params=+sip.instance="<urn:uuid:11111111-2222-4333-8444-555555555555>"' "$pjsip"
grep -Fq 'support_outbound=yes' "$pjsip"
grep -Fq 'support_path=yes' "$pjsip"
grep -Fq 'line=yes' "$pjsip"
grep -Fq 'endpoint=sipgate-endpoint' "$pjsip"
