...
SIPGATE_INSTANCE_ID="${SIPGATE_INSTANCE_ID:-6c458ca8-5814-4d22-9120-bb51a61a0c84}"
...
export LIVEKIT_SIP_PORT LIVEKIT_SIP_TRANSPORT SIPGATE_REGISTRAR SIPGATE_INSTANCE_ID DEFAULT_COUNTRY_CODE
mkdir -p "$CONFIG_OUTPUT_DIR"

envsubst '${EXTERNAL_IP} ${SIPGATE_USER} ${SIPGATE_PASS} ${SIPGATE_REGISTRAR} ${SIPGATE_INSTANCE_ID} ${LIVEKIT_SIP_HOST} ${LIVEKIT_SIP_PORT} ${LIVEKIT_SIP_TRANSPORT} ${LIVEKIT_SIP_USER} ${LIVEKIT_SIP_PASS}' \
